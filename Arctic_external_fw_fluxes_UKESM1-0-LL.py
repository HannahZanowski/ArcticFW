...
##############Arctic_external_fw_fluxes_UKESM1-0-LL.py#################
#Compute river and p-e fluxes into Arctic Ocean
...
xda=xr.open_dataset(direca_static+'areacella/gn/v20190705/areacella/areacella_fx_'+model+'_piControl_r1i1p1f2_gn.nc')
...
xdo=xr.open_dataset(direco_static+'areacello/gn/v20190705/areacello/areacello_Ofx_'+model+'_piControl_r1i1p1f2_gn.nc')
